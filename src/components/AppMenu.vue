<template>
    <div class="accordion" id="accordionExample">
        ...
        <div class="accordion-item">
            ...
            <div id="collapse2" class="accordion-collapse show" 
                data-bs-parent="#accordionExample">
            <div class="accordion-body">
                <ul class="nav flex-column">
                    <li class="nav-item">
        ...
        <div class="accordion-item">
            ...
            <div class="accordion-body">
                ...
                <li class="nav-item">
                    <RouterLink to="/Ch03DataBinding/Exam02State" class="nav-link">
                        Exam02State: 상태 데이터</RouterLink>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <RouterLink to="/Ch03DataBinding/Exam10FallthroughAttr" class="nav-link">
                        Exam10FallthroughAttr: Fallthrough(템플릿 루트로 그대로 전달되는) 속성</RouterLink>
                </li>
                <li class="nav-item">
                    <RouterLink to="/Ch03DataBinding/Exam11Slot" class="nav-link">
                        Exam11Slot: 속성</RouterLink>
                </li>
                </ul>
            </div>
            </div>
